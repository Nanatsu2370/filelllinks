...
async def start(_, msg: Message):
    buttons = [[InlineKeyboardButton(Strings.dev_channel, url=f'https://t.me/worldoffreedown')]]
    if Config.Bot_Channel:
        buttons.append([InlineKeyboardButton(Strings.bot_channel, url=f'https://t.me/worldoffreedown')])
